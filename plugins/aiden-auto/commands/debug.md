...
[AskUserQuestion] 세션 취소
  question: "지금까지 모은 디버그 진행 상태를 모두 버리고
             세션을 취소합니다. 지금 가설/증거가 사라집니다.
             취소할까요?"
  header: "세션 취소"
  multiSelect: false
  options:
    - 예, 세션 취소: "진행 상태를 버리고 세션을 끝냅니다.
        모아둔 가설과 증거가 사라집니다 (아카이브로만 남음)."
    - 아니오, 유지: "세션을 그대로 둡니다.
        모아둔 가설/증거가 보존되고 이어서 진행할 수 있습니다."
  → 사용자 선택: 예, 세션 취소
