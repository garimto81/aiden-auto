...
### Step 1.0: Reader Plan (rule 19 § P7, v28.3 복잡도 분기)

**복잡도 기반 분기** (정책 critic audit P0-2, 2026-05-14 완화):

| 복잡도 | Reader Plan | 비고 |
|--------|:-----------:|------|
| LIGHT (<100줄, 단순 메모/요약) | 스킵 권장 | writer 직접 호출, 과도한 오버헤드 회피 |
| STANDARD (100-300줄) | 4종 사전 설계 권장 | 품질 향상 목적, 강제 아님 |
| HEAVY (300+줄, PRD/spec) | 4종 사전 설계 권장 | 깊이 있는 사전 설계 가치 큼 |
| `!quick` magic word | 자동 스킵 | 사용자 명시 우회 |

writer는 STANDARD/HEAVY 모드에서 다음 4종을 사전 설계한 뒤 본문 작성 (LIGHT는 직접 작성):
