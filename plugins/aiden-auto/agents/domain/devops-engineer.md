...
description: Unified DevOps specialist (CI/CD, K8s, Terraform, troubleshooting). Use PROACTIVELY for pipelines, containerization, infrastructure as code, or production issues.
