...
description: Unified expert across cloud infrastructure, networking, and cost optimization. Use PROACTIVELY for AWS/Azure/GCP architecture, networking, cost optimization, or migration planning.
